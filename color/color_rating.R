...
set.seed(123)
data <- data.frame(
  variable = rep(c("gender", "content_language", "content_genre", "age", "ads", "profiles"), each = 2),
  category = c("female", "male",
               "Hindi/German", "Korean/German", 
               "action/drama", "horror",
               "old", "old",
               "less", "more",
               "more", "less"
...
#
title <- ggdraw() + 
  draw_label("The tendency of variable categories towards rating_given", 
